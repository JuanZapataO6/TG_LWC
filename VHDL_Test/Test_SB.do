...
add wave -noupdate /saturnin_block_encryptv2/En_SB_Main
add wave -noupdate /saturnin_block_encryptv2/Enable_SB
add wave -noupdate /saturnin_block_encryptv2/USBox/presente

add wave -noupdate -radix hexadecimal /saturnin_block_encryptv2/Addr_Rd_SBB
...
add wave -noupdate /saturnin_block_encryptv2/Rd_En_SBB
...
add wave -noupdate -radix hexadecimal /saturnin_block_encryptv2/Addr_Wr_SBB
...
add wave -noupdate -format Literal -color yellow -radix hexadecimal /saturnin_block_encryptv2/USBox/Data_Out_B
add wave -noupdate -format Literal -color yellow -radix hexadecimal /saturnin_block_encryptv2/USBox/Addr_Rd_B
